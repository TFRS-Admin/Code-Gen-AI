// Website entity — self-hosted stub replacing Base44 SDK
// Persists generated websites in localStorage until the Blair server DB is wired.

const STORE_KEY = 'blair_websites';
